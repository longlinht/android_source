...
int main(int argc, char **argv)
{
    ...
    /* After parsing above two files, would get a series actions.
     * Below two line will execute early-init stage action.Init
     * seperate execute time into four stage: early-init, init, 
     * early boot, boot.
    */
