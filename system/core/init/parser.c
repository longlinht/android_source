...
static void parse_line_service(struct parse_state *state, int nargs, char **args)
{
    ...
    case K_oneshot:
         ...
         * SVC_RESTARTING: Waiting to restart, service's state
         * SVC_CONSOLE: Need console.
         * SVC_CRITICAL: If service restart several times in certain 
         * duration, the system will restart and enter recovery mode
         */
